...
export default {
  ...
  methods: {
    ...
    showTest(arg) {
      ...
      this.summ_quality = "Can you extract this bolded main point present in the summary from the document?";
      this.summ_quality_rules = "<strong>Instructions</strong><br/> <strong>3</strong>: The bolded main point in the summary is explicitly described in the document. <br/> <strong>2</strong>: The bolded main point is not explicitly mentioned in the document. However, it can be deduced from the document.<br/> <strong>1</strong>: The bolded main point is not mentioned in the document at all.<br/>"
