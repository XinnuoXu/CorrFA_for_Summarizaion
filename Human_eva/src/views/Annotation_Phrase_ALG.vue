       ...
       <div class="column is-3">
         <div class="box instruction">
           <div class="content">
             ...
             <!-- eslint-disable -->
               <p class="my-text">Your task is to highlight informative phrases in the document that support the bolded part in the given summary the best.</p>
               <p class="my-text">The maximum combined length of all highlighted phrases is <strong>{{ maxTokens }} words.</strong></p>
               <hr/>
       ...
       <div class="column is-3">
         <div class="box summary">
           <div class="content">
             ...
             <hr/>
             <h4 class="my-title">Chunks left</h4>
             <p>{{chunksLeft}} chunks.</p>
             <hr/>
        ...
        <div class="column is-8 is-offset-2 box content">
            <div align="center">
                ...
                <div class="level" align="center"
                            ...
                            <template>
                            <vue-slider min="1" max="3" v-model="squality" width="90%"></vue-slider>
                            </template>
                            </span>
                            <span class="level-right">
                                <label class="label is-small">3</label>
                            </span>
                </div>
                <hr/>
...
export default {
  ...
  methods: {
    ...
    showTest(arg) {
      ...
      this.summ_quality = "Can you extract this bolded noun phrase present in the summary from the document?";
      this.summ_quality_rules = "<strong>Instructions</strong><br/> <strong>3</strong>: The bolded noun phrase in the summary is explicitly described in the document. <br/> <strong>2</strong>: The bolded noun phrase is not explicitly mentioned in the document. However, it can be deduced from the document.<br/> <strong>1</strong>: The bolded noun phrase is not mentioned in the document at all.<br/>"
    ...
    updateSummaryBox(data) {
      ...
      this.chunksLeft = maxHL - data.chunks;
